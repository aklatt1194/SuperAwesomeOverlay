...
public class SqliteTest extends TestCase{
    ...
    public void testDb() {     
        ...
        dbManager.addThroughputData(node1, System.currentTimeMillis(), rand.nextDouble() * 100);
        ...
        Map<Long, Double> data2 = dbManager.getThroughputData(node1, 0, System.currentTimeMillis());
        
        for (Long l : data2.keySet()) {
            System.out.println("Time: " + new Date(l).toGMTString() + " , Throughput: " + data2.get(l));
        }
