...
public interface DatabaseManager {
     ...
     * 
     * @param nodeName The name of the node we are connected to
    ...
    /**
     * Add the given throughput value for the connection to the given node at the 
     * given time to the db
     * 
     * @param nodeName The name of the node we are connected to
     * @param time The time the data was collected
    ...
    /**
     * Get all latency data for the connection to the given node between startTime
     * and endTime
     * 
     * @param node The node we are connected to
     * @param startTime The beginning of the interval we are interested in (inclusive)
    ...
    /**
     * Get all throughput data for the connection to the given node between startTime
     * and endTime
     * 
     * @param node The node we are connected to
     * @param startTime The beginning of the interval we are interested in (inclusive)
