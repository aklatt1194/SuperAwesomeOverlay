...
public class CopyOfNetworkInterface implements Runnable {
    ...
    private static CopyOfNetworkInterface instance = null;
    ...
    public static CopyOfNetworkInterface getInstance() {
        if (instance == null)
            instance = new CopyOfNetworkInterface();
        return instance;
    }

    private CopyOfNetworkInterface() {
    }
